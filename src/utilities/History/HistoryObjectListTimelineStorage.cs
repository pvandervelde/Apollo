...
namespace Apollo.Utilities.History
{
    ...
    /// </remarks>
    internal sealed class HistoryObjectListTimelineStorage<T> : ListTimelineStorage<T, HistoryId> where T : IAmHistoryEnabled
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HistoryObjectListTimelineStorage{T}"/> class.
        /// </summary>
        ...
        /// </exception>
        public HistoryObjectListTimelineStorage(Func<HistoryId, T> lookupFunc)
