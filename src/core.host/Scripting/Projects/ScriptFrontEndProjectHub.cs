...
{
    /// <summary>
    /// Forms the front-end facade over the project hub for the scripting API.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    internal sealed class ScriptFrontEndProjectHub : MarshalByRefObject, ILinkScriptsToProjects
    {
        /// <summary>
