...
{
    /// <summary>
    /// Forms the front-end facade over a project for the scripting API.
    /// </summary>
    /// <design>
    /// <para>
    ...
    /// </remarks>
    internal sealed class ScriptFrontEndProjectFacade : MarshalByRefObject, IProjectScriptFacade
    {
        /// <summary>
        /// The object that describes the current project.
        /// </summary>
        private readonly ScriptBackEndProjectFacade m_Current;
        ...
        public IDatasetScriptFacade Root()
        {
            ...
            return new ScriptFrontEndDatasetFacade(dataset);
        }
