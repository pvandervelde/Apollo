...
namespace Apollo.Core.Host.Plugins.Definitions
{
    ...
    /// </summary>
    [Serializable]
    internal sealed class SerializedGroupExportDefinition : IEquatable<SerializedGroupExportDefinition>
    {
        /// <summary>
        ...
        public static bool operator ==(SerializedGroupExportDefinition first, SerializedGroupExportDefinition second)
        {
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="SerializedGroupExportDefinition"/> class.
        /// </summary>
        ...
        /// </exception>
        public static SerializedGroupExportDefinition CreateDefinition(
            string contractName, 
            ...
            IEnumerable<ExportRegistrationId> providedExports)
        {
            ...
            return new SerializedGroupExportDefinition(
                contractName, 
                containingGroup, 
                schedule, 
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SerializedGroupExportDefinition"/> class.
        /// </summary>
        /// <param name="contractName">The contract name for the import.</param>
        /// <param name="containingGroup">The ID of the group that has registered the import.</param>
        /// <param name="schedule">The schedule that is exported with the group.</param>
        /// <param name="providedExports">The object exports that are provided with the current export.</param>
        public SerializedGroupExportDefinition(
            string contractName, 
            GroupRegistrationId containingGroup, 
            ScheduleId schedule, 
            IEnumerable<ExportRegistrationId> providedExports)
        ...
        /// <summary>
        /// Determines whether the specified <see cref="SerializedGroupExportDefinition"/> is equal to this instance.
        /// </summary>
        /// <param name="other">The <see cref="SerializedGroupExportDefinition"/> to compare with this instance.</param>
        /// <returns>
        ///     <see langword="true"/> if the specified <see cref="SerializedGroupExportDefinition"/> is equal to this instance;
        ///     otherwise, <see langword="false"/>.
        /// </returns>
        [SuppressMessage("Microsoft.StyleCop.CSharp.DocumentationRules", "SA1628:DocumentationTextMustBeginWithACapitalLetter",
            Justification = "Documentation can start with a language keyword")]
        public bool Equals(SerializedGroupExportDefinition other)
        {
        ...
        public sealed override bool Equals(object obj)
        {
            ...
            var id = obj as SerializedGroupExportDefinition;
            return Equals(id);
        }
