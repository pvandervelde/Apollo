...
namespace Apollo.Core.Host.Plugins.Definitions
{
    ...
    /// </summary>
    [Serializable]
    internal sealed class SerializedParameterDefinition : IEquatable<SerializedParameterDefinition>
    {
        /// <summary>
        ...
        public static bool operator ==(SerializedParameterDefinition first, SerializedParameterDefinition second)
        {
        ...
        /// <summary>
        /// Determines whether the specified <see cref="SerializedParameterDefinition"/> is equal to this instance.
        /// </summary>
        /// <param name="other">The <see cref="SerializedParameterDefinition"/> to compare with this instance.</param>
        /// <returns>
        ///     <see langword="true"/> if the specified <see cref="SerializedParameterDefinition"/> is equal to this instance;
        ///     otherwise, <see langword="false"/>.
        /// </returns>
        [SuppressMessage("Microsoft.StyleCop.CSharp.DocumentationRules", "SA1628:DocumentationTextMustBeginWithACapitalLetter",
            Justification = "Documentation can start with a language keyword")]
        public bool Equals(SerializedParameterDefinition other)
        {
        ...
        public sealed override bool Equals(object obj)
        {
            ...
            var id = obj as SerializedParameterDefinition;
            return Equals(id);
        }
