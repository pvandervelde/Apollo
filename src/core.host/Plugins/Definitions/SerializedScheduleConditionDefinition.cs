...
namespace Apollo.Core.Host.Plugins.Definitions
{
    ...
    internal abstract class SerializedScheduleConditionDefinition : IEquatable<SerializedScheduleConditionDefinition>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SerializedScheduleConditionDefinition"/> class.
        /// </summary>
        ...
        /// </exception>
        protected SerializedScheduleConditionDefinition(string contractName)
        {
            {
