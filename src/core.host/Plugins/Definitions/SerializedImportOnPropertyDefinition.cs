...
namespace Apollo.Core.Host.Plugins.Definitions
{
    ...
    /// </summary>
    [Serializable]
    internal sealed class SerializedImportOnPropertyDefinition : SerializedImportDefinition
    {
        /// <summary>
        ...
        public static bool operator ==(SerializedImportOnPropertyDefinition first, SerializedImportOnPropertyDefinition second)
        {
        ...
        ///     Thrown if <paramref name="property"/> is <see langword="null" />.
        /// </exception>
        public static SerializedImportOnPropertyDefinition CreateDefinition(string contractName, PropertyInfo property)
        {
        ...
        {
            var otherType = other as SerializedImportOnPropertyDefinition;
        ...
        public override bool Equals(object obj)
        {
            ...
            var id = obj as SerializedImportOnPropertyDefinition;
            return Equals(id);
        }
