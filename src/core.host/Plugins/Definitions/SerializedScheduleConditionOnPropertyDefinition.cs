...
namespace Apollo.Core.Host.Plugins.Definitions
{
    ...
    /// </summary>
    [Serializable]
    internal sealed class SerializedScheduleConditionOnPropertyDefinition : SerializedScheduleConditionDefinition
    {
        /// <summary>
        ...
        public static bool operator ==(SerializedScheduleConditionOnPropertyDefinition first, SerializedScheduleConditionOnPropertyDefinition second)
        {
        ...
        ///     Thrown if <paramref name="property"/> is <see langword="null" />.
        /// </exception>
        public static SerializedScheduleConditionOnPropertyDefinition CreateDefinition(string contractName, PropertyInfo property)
        {
        ...
        private SerializedScheduleConditionOnPropertyDefinition(string contractName, SerializedPropertyDefinition property)
            : base(contractName)
        {
            {
        ...
        {
            var otherType = other as SerializedScheduleConditionOnPropertyDefinition;
