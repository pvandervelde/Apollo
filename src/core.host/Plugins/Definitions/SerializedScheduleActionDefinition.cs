...
namespace Apollo.Core.Host.Plugins.Definitions
{
    ...
    internal sealed class SerializedScheduleActionDefinition : IEquatable<SerializedScheduleActionDefinition>
    {
            ...
            Func<Type, SerializedTypeIdentity> identityGenerator)
        {
            ...
            return new SerializedScheduleActionDefinition(contractName, SerializedMethodDefinition.CreateDefinition(method, identityGenerator));
        }
        ...
        ///     Thrown if <paramref name="method"/> is <see langword="null" />.
        /// </exception>
        public static SerializedScheduleActionDefinition CreateDefinition(string contractName, MethodInfo method)
        {
        ...
        private SerializedScheduleActionDefinition(string contractName, SerializedMethodDefinition method)
        {
            {
