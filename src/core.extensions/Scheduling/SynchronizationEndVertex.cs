...
namespace Apollo.Core.Extensions.Scheduling
{
    ...
    /// </summary>
    [Serializable]
    public sealed class SynchronizationEndVertex : IScheduleVertex
    {
        /// <summary>
        ...
        public static bool operator ==(SynchronizationEndVertex first, SynchronizationEndVertex second)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SynchronizationEndVertex"/> class.
        /// </summary>
        /// <param name="index">The index of the vertex in the graph.</param>
        public SynchronizationEndVertex(int index)
        {
            Index = index;
        }
