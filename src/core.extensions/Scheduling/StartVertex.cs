...
namespace Apollo.Core.Extensions.Scheduling
{
    ...
    /// </remarks>
    [Serializable]
    public sealed class StartVertex : IScheduleVertex
    {
        /// <summary>
        ...
        public static bool operator ==(StartVertex first, StartVertex second)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StartVertex"/> class.
        /// </summary>
        /// <param name="index">The index of the vertex in the graph.</param>
        public StartVertex(int index)
        {
            Index = index;
        }
