...
{
    /// <summary>
    /// A vertex for the schedule which indicates that the schedule graph ends at this position.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    [Serializable]
    public sealed class EndVertex : IScheduleVertex
    {
        /// <summary>
        ...
        public static bool operator ==(EndVertex first, EndVertex second)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EndVertex"/> class.
        /// </summary>
        /// <param name="index">The index of the vertex in the graph.</param>
        public EndVertex(int index)
        {
            Index = index;
        }
