...
namespace Apollo.Core.Extensions.Scheduling
{
    ...
    /// </remarks>
    [Serializable]
    public sealed class MarkHistoryVertex : IScheduleVertex
    {
        /// <summary>
        ...
        public static bool operator ==(MarkHistoryVertex first, MarkHistoryVertex second)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MarkHistoryVertex"/> class.
        /// </summary>
        /// <param name="index">The index of the vertex in the graph.</param>
        public MarkHistoryVertex(int index)
        {
            Index = index;
        }
