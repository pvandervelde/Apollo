...
{
    /// <summary>
    /// Defines the ID of a registration of a schedule condition.
    /// </summary>
    [Serializable]
    public sealed class ScheduleConditionRegistrationId : Id<ScheduleConditionRegistrationId, string>
    {
        /// <summary>
        ...
        /// </exception>
        private ScheduleConditionRegistrationId(string id)
            : base(id)
        {
            {
        ...
        /// </returns>
        protected override ScheduleConditionRegistrationId Clone(string value)
        {
            return new ScheduleConditionRegistrationId(value);
        }
        ...
        {
            return string.Format(CultureInfo.InvariantCulture, @"Schedule condition registration: {0}", InternalValue);
        }
    }
}
