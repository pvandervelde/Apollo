...
{
    /// <summary>
    /// A message send to request the current project. The response message will
    /// be a <see cref="ProjectRequestResponseMessage"/>.
    /// </summary>
    [Serializable]
    internal sealed class ProjectRequestMessage : MessageBody
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectRequestMessage"/> class.
        /// </summary>
        ...
        {
            return new ProjectRequestMessage();
        }
        ...
        public override bool Equals(MessageBody other)
        {
            ...
            return other is ProjectRequestMessage;
        }
