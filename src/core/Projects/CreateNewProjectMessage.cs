...
{
    /// <summary>
    /// A message send to request the creation of a new project. The response message will
    /// be a <see cref="ProjectRequestResponseMessage"/>.
    /// </summary>
    [Serializable]
    public sealed class CreateNewProjectMessage : MessageBody
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateNewProjectMessage"/> class.
        /// </summary>
        public CreateNewProjectMessage()
            : base(true)
        {
        }
        ...
        {
            return new CreateNewProjectMessage();
        }
        ...
        public override bool Equals(MessageBody other)
        {
            ...
            return other is CreateNewProjectMessage;
        }
        ...
        {
            return "Request creation of new project.";
        }
