...
//-----------------------------------------------------------------------
// <auto-generated>
//     This code was generated by a tool on 2011-05-19T23:29:56.1687202+12:00.
//
...
namespace Apollo.Core.Utilities.Licensing
{
    ...
    public sealed class ValidationServiceLicenseValidatorTest
    {
        ...
        public void CreateWithNullValidationResult()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new ValidationServiceLicenseValidator(new Mock<ILicenseValidationCache>().Object, null, () => DateTimeOffset.Now));
        }
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new ValidationServiceLicenseValidator(new Mock<ILicenseValidationCache>().Object, (sum, generated, expires) => { }, null));
        }
