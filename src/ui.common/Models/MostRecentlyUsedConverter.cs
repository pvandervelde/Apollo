...
namespace Apollo.UI.Common.Models
{
    ...
    /// </summary>
    /// <remarks>
    /// This class is mainly used to serialize the <see cref="MostRecentlyUsed"/> class in the application settings.
    /// </remarks>
    public sealed class MostRecentlyUsedConverter : TypeConverter
    {
        /// <summary>
