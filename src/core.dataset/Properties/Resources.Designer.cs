...
namespace Apollo.Core.Dataset.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The GUID for a part instance ID cannot be equal to the invalid GUID..
        /// </summary>
        internal static string Exceptions_Messages_PartInstanceIdCannotBeTheInvalidId {
            get {
                return ResourceManager.GetString("Exceptions_Messages_PartInstanceIdCannotBeTheInvalidId", resourceCulture);
            }
        }
