...
namespace Apollo.Core.Host.Scripting.Projects
{
    ...
    public sealed class ScriptFrontEndDatasetFacadeTest : EqualityContractVerifierTest
    {
        private sealed class ScriptFrontEndDatasetFacadeEqualityContractVerifier : EqualityContractVerifier<ScriptFrontEndDatasetFacade>
        {
            private readonly ScriptFrontEndDatasetFacade m_First 
                = new ScriptFrontEndDatasetFacade(new ScriptBackEndDatasetFacade(new DatasetFacade(CreateMockDataset())));

            private readonly ScriptFrontEndDatasetFacade m_Second
                = new ScriptFrontEndDatasetFacade(new ScriptBackEndDatasetFacade(new DatasetFacade(CreateMockDataset())));

            protected override ScriptFrontEndDatasetFacade Copy(ScriptFrontEndDatasetFacade original)
            {
                return new ScriptFrontEndDatasetFacade(original.Facade);
            }

            protected override ScriptFrontEndDatasetFacade FirstInstance
            {
                get
                {
                    return m_First;
            ...
            protected override ScriptFrontEndDatasetFacade SecondInstance
            {
                get
                {
                    return m_Second;
        ...
        private sealed class ScriptFrontEndDatasetFacadeHashcodeContractVerfier : HashcodeContractVerifier
        {
            private readonly IEnumerable<ScriptFrontEndDatasetFacade> m_DistinctInstances
                = new List<ScriptFrontEndDatasetFacade> 
                     {
                        new ScriptFrontEndDatasetFacade(new ScriptBackEndDatasetFacade(new DatasetFacade(CreateMockDataset()))),
                        new ScriptFrontEndDatasetFacade(new ScriptBackEndDatasetFacade(new DatasetFacade(CreateMockDataset()))),
                        new ScriptFrontEndDatasetFacade(new ScriptBackEndDatasetFacade(new DatasetFacade(CreateMockDataset()))),
        ...
        private readonly ScriptFrontEndDatasetFacadeHashcodeContractVerfier m_HashcodeVerifier 
            = new ScriptFrontEndDatasetFacadeHashcodeContractVerfier();

        private readonly ScriptFrontEndDatasetFacadeEqualityContractVerifier m_EqualityVerifier 
            = new ScriptFrontEndDatasetFacadeEqualityContractVerifier();
        ...
        public void AddChild()
        {
            ...
            Assert.AreEqual(new ScriptFrontEndDatasetFacade(new ScriptBackEndDatasetFacade(new DatasetFacade(child))), childFacade);
