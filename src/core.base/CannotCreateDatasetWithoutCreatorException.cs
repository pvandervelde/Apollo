...
namespace Apollo.Core.Base
{
    ...
    /// </summary>
    [Serializable]
    public sealed class CannotCreateDatasetWithoutCreatorException : Exception
    {
        /// <summary>
        ...
        public CannotCreateDatasetWithoutCreatorException(string message) 
            : base(message)
        {
        }
        ...
        public CannotCreateDatasetWithoutCreatorException(string message, Exception innerException)
        ...
        /// </exception>
        private CannotCreateDatasetWithoutCreatorException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
    }
