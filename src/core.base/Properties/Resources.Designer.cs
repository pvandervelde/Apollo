...
namespace Apollo.Core.Base.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The GUID for a group composition ID cannot be the invalid GUID..
        /// </summary>
        internal static string Exceptions_Messages_GroupCompositionIdCannotBeTheInvalidId {
            get {
                return ResourceManager.GetString("Exceptions_Messages_GroupCompositionIdCannotBeTheInvalidId", resourceCulture);
            }
        }
