...
//-----------------------------------------------------------------------
// <auto-generated>
//     This code was generated by a tool on 2010-07-26T20:59:06.2527702+12:00.
//
...
namespace Apollo.Utils.Licensing
{
    ...
    public sealed class LicenseValidationCacheTest
    {
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new LicenseValidationCache(new MockValidator(true), null, () => 42.0));
        }
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new LicenseValidationCache(new MockValidator(true), () => DateTimeOffset.Now, null));
        }
        ...
        public void Create()
        {
            ...
            var cache = new LicenseValidationCache(new MockValidator(true), () => now, () => 42.0);
        ...
        { 
            var cache = new LicenseValidationCache(new MockValidator(true), () => DateTimeOffset.Now, () => 42.0);
        ...
        { 
            ...
            var cache = new LicenseValidationCache(new MockValidator(false), () => now, randomizer);
        ...
        { 
            ...
            var cache = new LicenseValidationCache(new MockValidator(true), () => now, randomizer);
