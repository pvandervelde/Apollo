...
//-----------------------------------------------------------------------
// <auto-generated>
//     This code was generated by a tool on 2010-11-23T22:51:43.2995165+13:00.
//
...
namespace Apollo.Utils.Licensing
{
    ...
    public sealed class LicenseValidatorTest
    {
        ...
        public void CreateWithNullValidationResult()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new LicenseValidator(new Mock<ILicenseValidationCache>().Object, null, () => DateTimeOffset.Now));
        }
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new LicenseValidator(new Mock<ILicenseValidationCache>().Object, (sum, generated, expires) => { }, null));
        }
        ...
        { 
            ...
            var validator = new LicenseValidator(cache.Object, onValidationResult, now);
