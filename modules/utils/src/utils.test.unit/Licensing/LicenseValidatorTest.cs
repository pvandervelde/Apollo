...
namespace Apollo.Utils.Licensing
{
	...
	public sealed class LicenseValidatorTest
	{
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new LicenseValidator(null, (sum, offset) => { }, () => DateTimeOffset.Now));
        }
        ...
        public void CreateWithNullValidationResult()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new LicenseValidator(new MockVerificationCache(new LicenseCheckResult(), (TimePeriod period) => { }), null, () => DateTimeOffset.Now));
        }
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new LicenseValidator(new MockVerificationCache(new LicenseCheckResult(), (TimePeriod period) => { }), (sum, offset) => { }, null));
        }
