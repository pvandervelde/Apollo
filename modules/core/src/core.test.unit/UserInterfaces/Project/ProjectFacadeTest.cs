...
namespace Apollo.Core.UserInterfaces.Project
{
    ...
    public sealed class ProjectFacadeTest
    {
        ...
        public void CreateNewProjectWithLoadingFailure()
        {
            ...
            var facade = new ProjectFacade(service.Object);
        ...
        [Test]
        [Description("Checks that the root dataset cannot be obtained if there is no current project.")]
        public void RootWithoutCurrentProject()
        {
            var service = new Mock<IUserInterfaceService>();
            var facade = new ProjectFacade(service.Object);
            Assert.Throws<NoCurrentProjectException>(() => facade.Root());
        }
        ...
        public void Root()
        {
            ...
            var project = marshal.As<IProject>();
            {
                project.Setup(p => p.BaseDataset())
                    .Returns(new Mock<IReadOnlyDataset>().Object);
            }
