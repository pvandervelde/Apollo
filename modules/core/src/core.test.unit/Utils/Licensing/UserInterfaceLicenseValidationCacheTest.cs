...
//-----------------------------------------------------------------------
// <auto-generated>
//     This code was generated by a tool on 2010-07-26T21:24:50.0190686+12:00.
//
...
{
    [TestFixture]
    [Description("Tests the UserInterfaceLicenseValidationCacheTest class.")]
    [SuppressMessage("Microsoft.StyleCop.CSharp.DocumentationRules", "SA1600:ElementsMustBeDocumented",
            Justification = "Unit tests do not need documentation.")]
    public sealed class UserInterfaceLicenseValidationCacheTest
    {
        ...
        { 
            Assert.Throws<ArgumentNullException>(() => new UserInterfaceLicenseValidationCache(null, () => DateTimeOffset.Now, () => 42.0));
        }
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new UserInterfaceLicenseValidationCache(new MockValidator(true), null, () => 42.0));
        }
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new UserInterfaceLicenseValidationCache(new MockValidator(true), () => DateTimeOffset.Now, null));
        }
        ...
        public void Create()
        {
            ...
            var cache = new UserInterfaceLicenseValidationCache(new MockValidator(true), () => now, () => 42.0);
        ...
        { 
            var cache = new UserInterfaceLicenseValidationCache(new MockValidator(true), () => DateTimeOffset.Now, () => 42.0);
        ...
        { 
            ...
            var cache = new UserInterfaceLicenseValidationCache(new MockValidator(false), () => now, randomizer);
        ...
        { 
            ...
            var cache = new UserInterfaceLicenseValidationCache(new MockValidator(true), () => now, randomizer);
