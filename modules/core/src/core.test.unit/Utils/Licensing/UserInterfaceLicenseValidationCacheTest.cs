...
//-----------------------------------------------------------------------
// <auto-generated>
//     This code was generated by a tool on 2010-11-23T23:46:37.5709380+13:00.
//
...
namespace Apollo.Core.Utils.Licensing
{
    ...
    public sealed class UserInterfaceLicenseValidationCacheTest
    {
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new UserInterfaceLicenseValidationCache(new Mock<IValidator>().Object, null, () => 42.0));
        }
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new UserInterfaceLicenseValidationCache(new Mock<IValidator>().Object, () => DateTimeOffset.Now, null));
        }
        ...
        public void Create()
        {
            ...
            var cache = new UserInterfaceLicenseValidationCache(new Mock<IValidator>().Object, () => now, () => 42.0);
        ...
        { 
            var cache = new UserInterfaceLicenseValidationCache(new Mock<IValidator>().Object, () => DateTimeOffset.Now, () => 42.0);
        ...
        { 
            ...
            var cache = new UserInterfaceLicenseValidationCache(validator.Object, () => now, () => 42.0);
        ...
        { 
            ...
            var cache = new UserInterfaceLicenseValidationCache(validator.Object, () => now, randomizer);
