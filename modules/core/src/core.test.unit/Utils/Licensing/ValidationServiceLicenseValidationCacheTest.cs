...
namespace Apollo.Core.Utils.Licensing
{
    ...
    public sealed class ValidationServiceLicenseValidationCacheTest
    {
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new ValidationServiceLicenseValidationCache(new Mock<IValidator>().Object, null, () => 42.0));
        }
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new ValidationServiceLicenseValidationCache(new Mock<IValidator>().Object, () => DateTimeOffset.Now, null));
        }
        ...
        { 
            var cache = new ValidationServiceLicenseValidationCache(new Mock<IValidator>().Object, () => DateTimeOffset.Now, () => 42.0);
        ...
        { 
            ...
            var cache = new ValidationServiceLicenseValidationCache(validator.Object, () => now, () => 42.0);
