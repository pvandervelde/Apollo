...
{
    [TestFixture]
    [Description("Tests the CoreLicenseValidationCacheTest class.")]
    [SuppressMessage("Microsoft.StyleCop.CSharp.DocumentationRules", "SA1600:ElementsMustBeDocumented",
            Justification = "Unit tests do not need documentation.")]
    public sealed class CoreLicenseValidationCacheTest
    {
        ...
        { 
            Assert.Throws<ArgumentNullException>(() => new CoreLicenseValidationCache(null, () => DateTimeOffset.Now, () => 42.0));
        }
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new CoreLicenseValidationCache(new MockValidator(true), null, () => 42.0));
        }
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new CoreLicenseValidationCache(new MockValidator(true), () => DateTimeOffset.Now, null));
        }
        ...
        public void Create()
        {
            ...
            var cache = new CoreLicenseValidationCache(new MockValidator(true), () => now, () => 42.0);
        ...
        { 
            var cache = new CoreLicenseValidationCache(new MockValidator(true), () => DateTimeOffset.Now, () => 42.0);
        ...
        { 
            ...
            var cache = new CoreLicenseValidationCache(new MockValidator(false), () => now, randomizer);
        ...
        { 
            ...
            var cache = new CoreLicenseValidationCache(new MockValidator(true), () => now, randomizer);
