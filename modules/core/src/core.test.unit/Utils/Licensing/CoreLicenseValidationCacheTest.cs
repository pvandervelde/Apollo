...
//-----------------------------------------------------------------------
// <auto-generated>
//     This code was generated by a tool on 2010-11-23T23:46:37.5699380+13:00.
//
...
namespace Apollo.Core.Utils.Licensing
{
    ...
    public sealed class CoreLicenseValidationCacheTest
    {
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new CoreLicenseValidationCache(new Mock<IValidator>().Object, null, () => 42.0));
        }
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new CoreLicenseValidationCache(new Mock<IValidator>().Object, () => DateTimeOffset.Now, null));
        }
        ...
        public void Create()
        {
            ...
            var cache = new CoreLicenseValidationCache(new Mock<IValidator>().Object, () => now, () => 42.0);
        ...
        { 
            var cache = new CoreLicenseValidationCache(new Mock<IValidator>().Object, () => DateTimeOffset.Now, () => 42.0);
        ...
        { 
            ...
            var cache = new CoreLicenseValidationCache(validator.Object, () => now, () => 42.0);
        ...
        { 
            ...
            var cache = new CoreLicenseValidationCache(validator.Object, () => now, randomizer);
