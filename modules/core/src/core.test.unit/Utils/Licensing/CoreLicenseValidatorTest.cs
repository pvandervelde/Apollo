...
{
    [TestFixture]
    [Description("Tests the CoreLicenseValidatorTest class.")]
    [SuppressMessage("Microsoft.StyleCop.CSharp.DocumentationRules", "SA1600:ElementsMustBeDocumented",
            Justification = "Unit tests do not need documentation.")]
    public sealed class CoreLicenseValidatorTest
    {
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new CoreLicenseValidator(null, (sum, generated, expires) => { }, () => DateTimeOffset.Now));
        }
        ...
        public void CreateWithNullValidationResult()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new CoreLicenseValidator(new MockValidationCache(new LicenseCheckResult(), (TimePeriod period) => { }), null, () => DateTimeOffset.Now));
        }
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new CoreLicenseValidator(new MockValidationCache(new LicenseCheckResult(), (TimePeriod period) => { }), (sum, generated, expires) => { }, null));
        }
        ...
        { 
            ...
            var validator = new CoreLicenseValidator(cache, onValidationResult, now);
