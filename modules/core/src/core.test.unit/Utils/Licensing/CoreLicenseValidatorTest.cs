...
namespace Apollo.Core.Utils.Licensing
{
    ...
    public sealed class CoreLicenseValidatorTest
    {
        ...
        public void CreateWithNullValidationResult()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new CoreLicenseValidator(new Mock<ILicenseValidationCache>().Object, null, () => DateTimeOffset.Now));
        }
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new CoreLicenseValidator(new Mock<ILicenseValidationCache>().Object, (sum, generated, expires) => { }, null));
        }
        ...
        { 
            ...
            var validator = new CoreLicenseValidator(cache.Object, onValidationResult, now);
