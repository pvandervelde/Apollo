...
//-----------------------------------------------------------------------
// <auto-generated>
//     This code was generated by a tool on 2010-11-23T23:31:56.1545239+13:00.
//
...
namespace Apollo.Core.Utils.Licensing
{
    ...
    public sealed class UserInterfaceLicenseValidatorTest
    {
        ...
        public void CreateWithNullValidationResult()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new UserInterfaceLicenseValidator(new Mock<ILicenseValidationCache>().Object, null, () => DateTimeOffset.Now));
        }
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new UserInterfaceLicenseValidator(new Mock<ILicenseValidationCache>().Object, (sum, generated, expires) => { }, null));
        }
        ...
        { 
            ...
            var validator = new UserInterfaceLicenseValidator(cache.Object, onValidationResult, now);
