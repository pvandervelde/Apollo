...
//-----------------------------------------------------------------------
// <auto-generated>
//     This code was generated by a tool on 2010-07-26T21:01:33.8382116+12:00.
//
...
{
    [TestFixture]
    [Description("Tests the UserInterfaceLicenseValidatorTest class.")]
    [SuppressMessage("Microsoft.StyleCop.CSharp.DocumentationRules", "SA1600:ElementsMustBeDocumented",
            Justification = "Unit tests do not need documentation.")]
    public sealed class UserInterfaceLicenseValidatorTest
    {
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new UserInterfaceLicenseValidator(null, (sum, generated, expires) => { }, () => DateTimeOffset.Now));
        }
        ...
        public void CreateWithNullValidationResult()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new UserInterfaceLicenseValidator(new MockValidationCache(new LicenseCheckResult(), (TimePeriod period) => { }), null, () => DateTimeOffset.Now));
        }
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new UserInterfaceLicenseValidator(new MockValidationCache(new LicenseCheckResult(), (TimePeriod period) => { }), (sum, generated, expires) => { }, null));
        }
        ...
        { 
            ...
            var validator = new UserInterfaceLicenseValidator(cache, onValidationResult, now);
