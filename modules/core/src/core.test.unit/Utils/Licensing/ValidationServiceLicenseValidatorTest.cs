...
namespace Apollo.Core.Utils.Licensing
{
    ...
    public sealed class ValidationServiceLicenseValidatorTest
    {
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new ValidationServiceLicenseValidator(null, (sum, generated, expires) => { }, () => DateTimeOffset.Now));
        }
        ...
        public void CreateWithNullValidationResult()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new ValidationServiceLicenseValidator(new MockValidationCache(new LicenseCheckResult(), (TimePeriod period) => { }), null, () => DateTimeOffset.Now));
        }
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new ValidationServiceLicenseValidator(new MockValidationCache(new LicenseCheckResult(), (TimePeriod period) => { }), (sum, generated, expires) => { }, null));
        }
        ...
        { 
            ...
            var validator = new ValidationServiceLicenseValidator(cache, onValidationResult, now);
