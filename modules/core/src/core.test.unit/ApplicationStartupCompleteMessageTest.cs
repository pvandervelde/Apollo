...
{
    [TestFixture]
    [Description("Tests the ApplicationStartupCompleteMessage class.")]
    [SuppressMessage("Microsoft.StyleCop.CSharp.DocumentationRules", "SA1600:ElementsMustBeDocumented",
            Justification = "Unit tests do not need documentation.")]
    public sealed class ApplicationStartupCompleteMessageTest
    {
        [VerifyContract]
        ...
        public readonly IContract EqualityVerification = new EqualityContract<MessageBody>
        {
            ...
            EquivalenceClasses = new EquivalenceClassCollection<MessageBody> 
                { 
                    new ApplicationStartupCompleteMessage(),
                    new ApplicationShutdownCapabilityRequestMessage(),
                },
        };
        ...
        {
            var msg = new ApplicationStartupCompleteMessage();
