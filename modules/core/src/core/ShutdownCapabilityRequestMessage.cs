...
namespace Apollo.Core
{
    ...
    /// </summary>
    [Serializable]
    internal sealed class ShutdownCapabilityRequestMessage : MessageBody
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShutdownCapabilityRequestMessage"/> class.
        /// </summary>
        public ShutdownCapabilityRequestMessage()
            : base(true)
        {
        }
        ...
        {
            return new ShutdownCapabilityRequestMessage();
        }
        ...
        public override bool Equals(MessageBody other)
        {
            ...
            return other is ShutdownCapabilityRequestMessage;
        }
        ...
        {
            return "Request shutdown status.";
        }
