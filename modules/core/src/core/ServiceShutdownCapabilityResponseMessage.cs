...
namespace Apollo.Core
{
    ...
    /// </summary>
    [Serializable]
    internal sealed class ServiceShutdownCapabilityResponseMessage : MessageBody
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceShutdownCapabilityResponseMessage"/> class.
        /// </summary>
        /// <param name="canShutdown">If set to <see langword="true"/> then the sending service can be shutdown.</param>
        public ServiceShutdownCapabilityResponseMessage(bool canShutdown)
            : base(false)
        {
        ...
        {
            return new ServiceShutdownCapabilityResponseMessage(CanShutdown);
        }
        ...
        public override bool Equals(MessageBody other)
        {
            ...
            var message = other as ServiceShutdownCapabilityResponseMessage;
        ...
        {
            return CanShutdown ? "Service can shutdown." : "Service cannot shutdown.";
        }
